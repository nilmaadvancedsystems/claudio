...
Classificação: VOCABULARIO_AUSENTE · TIPO_INCOMPATIVEL_COM_REGIME · NOMENCLATURA_NAO_DEFINIDA · DESTINO_NAO_DEFINIDO · EMITENTE_INDETERMINADO · COLISAO_BANCARIO_RECEBIMENTO · COLISAO_DAS_DAE · COLISAO_GUIAS_FEDERAL_ESTADUAL · COLISAO_PERDCOMP · VINCULO_SOCIO_EMPRESA_INDISPONIVEL (04b/IRPF — pendência de dado, não de regra, ver §2.1)
